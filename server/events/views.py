...
from .serializers import EventCategorySerializer, EventDetailSerializer, EventRegistrationSerializer, EventSerializer
...
class EventCategoryViewSet(viewsets.ModelViewSet, ClinicView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        return self.clinic_response(data=serializer.data, message="Event categories retrieved successfully")

    def retrieve(self, request, *args, **kwargs):
        instance = self.get_object()
        serializer = self.get_serializer(instance)
        return self.clinic_response(data=serializer.data, message="Event category retrieved successfully")
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save()
            return self.clinic_response(
                data=serializer.data, message="Event category created successfully", status_code=status.HTTP_201_CREATED
            )
        return self.clinic_response(
            error=serializer.errors, message="Failed to create event category", status_code=status.HTTP_400_BAD_REQUEST
        )
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save()
            return self.clinic_response(data=serializer.data, message="Event category updated successfully")
        return self.clinic_response(
            error=serializer.errors, message="Failed to update event category", status_code=status.HTTP_400_BAD_REQUEST
        )
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        instance.delete()
        return self.clinic_response(
            message="Event category deleted successfully", status_code=status.HTTP_204_NO_CONTENT
        )
...
class EventViewSet(viewsets.ModelViewSet, ClinicView):
    ...
    def get_queryset(self):
        ...
        if upcoming == "true":
            ...
            queryset = queryset.filter(
                Q(start_date__range=(today_min, today_max)) | Q(start_date__lte=today_min, end_date__gte=today_min)
            )
    ...
    def list(self, request, *args, **kwargs):
        ...
        serializer = self.get_serializer(queryset, many=True)
        return self.clinic_response(data=serializer.data, message="Events retrieved successfully")

    def retrieve(self, request, *args, **kwargs):
        instance = self.get_object()
        serializer = self.get_serializer(instance)
        return self.clinic_response(data=serializer.data, message="Event retrieved successfully")
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return self.clinic_response(
                data=serializer.data, message="Event created successfully", status_code=status.HTTP_201_CREATED
            )
        return self.clinic_response(
            error=serializer.errors, message="Failed to create event", status_code=status.HTTP_400_BAD_REQUEST
        )
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save()
            return self.clinic_response(data=serializer.data, message="Event updated successfully")
        return self.clinic_response(
            error=serializer.errors, message="Failed to update event", status_code=status.HTTP_400_BAD_REQUEST
        )

    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        instance.delete()
        return self.clinic_response(message="Event deleted successfully", status_code=status.HTTP_204_NO_CONTENT)
    ...
    def register(self, request, slug=None):
        ...
        return self.clinic_response(
            data=serializer.data, message="Successfully registered for the event.", status_code=status.HTTP_201_CREATED
        )
    ...
    def unregister(self, request, slug=None):
        ...
        try:
            ...
            registration.delete()
            return self.clinic_response(
                message="Successfully unregistered from the event.", status_code=status.HTTP_200_OK
            )
...
class EventRegistrationViewSet(viewsets.ModelViewSet, ClinicView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        serializer = self.get_serializer(queryset, many=True)
        return self.clinic_response(data=serializer.data, message="Event registrations retrieved successfully")

    def retrieve(self, request, *args, **kwargs):
        instance = self.get_object()
        serializer = self.get_serializer(instance)
        return self.clinic_response(data=serializer.data, message="Event registration retrieved successfully")
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        instance.delete()
        return self.clinic_response(
            message="Event registration deleted successfully", status_code=status.HTTP_204_NO_CONTENT
        )
