...
class AppDataAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("name", "logo_url", "logo_preview")}),
        ("Statements", {"fields": ("mission_statement", "vision_statement")}),
...
class GalleryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Gallery Information", {"fields": ("title", "description")}),
        ("Classification", {"fields": ("department", "is_previous", "year", "ordering")}),
        ("Timestamps", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
...
class GalleryImageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Social Media", {"fields": ("instagram", "x_handle", "facebook")}),
        ("Display Settings", {"fields": ("ordering",)}),
    )
...
class SponsorAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Sponsor Information", {"fields": ("name", "description", "type", "url")}),
