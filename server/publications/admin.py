...
class PublicationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("title", "slug", "author", "categories", "status")}),
        ("Content", {"fields": ("content", "excerpt", "featured_image", "mins_read")}),
        (
            "SEO & Metadata",
            {"fields": ("meta_title", "meta_description", "keywords", "additional_metadata"), "classes": ("collapse",)},
        ),
        (
            "Publication Details",
