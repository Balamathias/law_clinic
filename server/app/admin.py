...
class CustomUserAdmin(UserAdmin):
    ...
    def get_avatar_display(self, obj):
        if obj.avatar:
            return format_html(
                '<img src="{}" width="50" height="50" style="border-radius:50%; object-cover: cover;" />', obj.avatar
            )
...
class HelpRequestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("id", "full_name", "email", "phone_number")}),
        ("Case Details", {"fields": ("legal_issue_type", "had_previous_help", "description")}),
