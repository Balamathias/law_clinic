      ...
      <div className="container mx-auto max-w-7xl px-4 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 xl:gap-20">
                ...
                <div className="space-y-3">
                  {upcomingEvents.slice(0, 3).map((event, idx) => (
                    <motion.div
                      ...
                      className="bg-white rounded-lg p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex items-center gap-3"
                    >
                      ...
                      <div className={`${categoryColors[event?.category_name as any] || 'bg-gray-500'} text-white text-xs px-2 py-1 rounded-full whitespace-nowrap`}>
                        {event.category_name}
                      </div>
                    </motion.div>
                  ))}
          ...
          <div className="lg:w-7/12">
            <div className="relative h-[500px] md:h-[550px] bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              <AnimatePresence initial={false} custom={direction}>
                ...
                >
                  <div 
                    ...
                    style={{ backgroundImage: `url(${currentEvent?.image || '/images/highlights/default.jpg'})` }}
                  >
                    <div className="absolute inset-0 bg-gradient-to-b from-black/30 to-transparent"></div>
                  </div>
                  
                  <div className="p-6 relative">
                    <div className={`${categoryColors[currentEvent?.category_name as any] || 'bg-primary'} absolute right-6 top-0 -translate-y-1/2 text-white px-4 py-2 rounded-full font-medium`}>
                      {currentEvent?.category_name}
                    </div>
                    
                    <h3 className="text-2xl font-bold mt-4 mb-3 text-gray-900">{currentEvent?.title}</h3>
                    ...
                    <p className="text-gray-600 mb-6 line-clamp-2">{currentEvent?.description}</p>
